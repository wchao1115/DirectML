...
// (HLSL-only path) Previous refactor removed Model::DmlDispatchableDesc; the prior temporary
// stub has been deleted. Remaining DirectML operator parsing helpers will be pruned later.
...
#if 0 // DML operator parsing disabled for HLSL-only path
...
#endif // DML operator parsing disabled
